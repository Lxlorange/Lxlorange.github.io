...
**杨皓然 (Haoran Yang)** 北京交通大学 · 软件学院 · 软件工程专业  
[GitHub](https://github.com/Lxlorange) | [Email](mailto:23301142@bjtu.edu.cn)

---

## 教育背景

**北京交通大学 (211 / 双一流)** | 2023.09 - 至今
- **专业**: 软件工程
...
- **多模态大模型道路状况识别系统** (第13届服务外包大赛)
  - 融合 **DeepSeek-VL2** 与 **YOLO-V8**，利用半监督学习感知道路隐患，构建闭环智能交通监管系统。
- **智慧思政 - 三全育人工作平台** (高校级商用 SaaS)
  - 负责智能通知模板开发，项目已在北林、北中医等多所高校推广部署。

---

## 专业技能

- **编程/工具**: Python (PyTorch, TensorFlow), C/C++, Java, Linux (WSL2), LaTeX
- **语言能力**: **CET-6 (477)**，具备良好的英文科研文献阅读与撰写能力
- **荣誉**: 优秀共青团干部、社会工作奖学金、社会实践奖学金等